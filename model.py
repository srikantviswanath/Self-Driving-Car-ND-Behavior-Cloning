...
def extract_driving_log(log_path, correction_steer=0.2):
    '''
    extracts data from .csv file and reads corresponding images before manipulating them
    :param float correction_steer: offset used to 're-center' the steer angle when reading fro left-mount or right-mount camera
    '''
...
def flip_images_steer(images, steer_angles):
    '''Given images and corresponding steer angles, horizontally flip them to augment more data'''
